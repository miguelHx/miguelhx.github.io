...
Overall it was a great course ! This course is meant to focus on language agnostic principles of systematic program design rather than specific programming language details, so the choice of language shouldn't be a let down necessarily.

It changed the way I think about approaching problem-solving and how to think about code in general. I feel like I can take these ideas beyond this course and am looking forward to applying them in the future.

This course also does a good job at establishing good programming habits such as the steps taken when designing functions and designing data.
...
So the first half of unit 1 is mainly about proofs and various math notations they use.  Then we learn about Sets, Binary Relations, State Machines, Recursion, and Infinite Sets.
...
I don't regret taking this course. It helped me brush up on my fundamentals knowledge.

Overall I am happy with what I've accomplished so far. I'm averaging about __18.57 hours__ each week of total effort on OSSU. I'm aiming for around __20 hours__ each week. Maybe my next run will have more effort.
...
I also want to work on one of my side projects.
