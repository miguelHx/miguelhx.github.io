...
What stuck out to me the most was the idea of encoding. When we learn information, we "encode" it into our brains. The encoding is stronger with deep processing of the information.  That is, processing the information in such a way that the neural connections are strong, well-organized, and thus more likely to be remembered.  Not only remembered, but fit in at the right spots in our mental models or knowledge structures.  Once new information is connected with other previous knowledge, it is more likely to stick.  The knowledge decay curve gets flatter.
...
Active recall and spaced repetition are techniques for making things stick.  By the way, there are many techniques.  And there is so much learning theory out there.  I want to recall what are the things I’ll be using in my next OSSU run below.
