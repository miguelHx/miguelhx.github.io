...
Why this course?  Even though I’m not a beginner, I decided to humble myself and take the course anyway to see what I could learn from it, and share my learnings.  Also, this course is a part of the [Open Source Society University’s Computer Science](https://github.com/ossu/computer-science) curriculum (OSSU).  I am going through this curriculum to strengthen my fundamentals, as I discuss in my blog post [here](revisiting-software-fundamentals.html).
...
Beginner students can often get stuck staring at a problem, not knowing where to even start.  SPD solves that problem by giving students a recipe to follow when approaching any programming problem. All credit to the instructor and authors of How to Design Programs book, it’s a great process to follow that’s better than no process at all.

Even if you're experienced, I think this course will still be useful.  You can apply the ideas to other programming languages or environments.
...
Systematic Program Design is a course taught by [Gregor Kiczales](https://en.wikipedia.org/wiki/Gregor_Kiczales), a computer science professor at the University of British Colombia.  He is best known for developing the concept of Aspect-Oriented Programming.  However, this concept is not relevant to the course.  Feel free to do some research if you want, but you don’t need to understand it in order to take this course.

The course is based on the book [How to Design Programs, 2nd edition](https://htdp.org/).  No need to read the book if you are taking this class.  But I do recommend checking out the preface [here](https://htdp.org/2020-5-6/Book/part_preface.html), which talks about what you’ll learn from the book, and gives an overview.  There is some debate as to whether How to Design Programs or [SICP](https://sarabander.github.io/sicp/html/index.xhtml) (Structure and Interpretation of Computer Programs) is better as an introductory course.

After doing some research and reading [this](https://cs.brown.edu/people/sk/Publications/Papers/Published/fffk-htdp-vs-sicp-journal/paper.pdf) paper comparing the two (though it’s written by the authors of How to Design Programs, so it may be biased), it seems to me that How to Design Programs (or courses based on HTDP such as SPD) might be better as an introductory.  That’s not to say that SICP is useless.  In fact, I do plan on reading SICP sometime, maybe after completing the Core Programming section of OSSU.  It’s a part of the [teachyourselfcs](https://teachyourselfcs.com) curriculum.  But I digress.  Now, about the Systematic Program Design course structure.
...
Interesting thing is that recently this course offered at the actual university is now [using Python](https://felleisen.org/matthias/Thoughts/py.html) as their main language to teach systematic program design instead of BSL:
...
Still, that doesn’t mean you won’t learn anything by using the learning language for this course.  Trust the process, and keep in mind that although the language won’t be super relevant beyond this course, the main ideas will be.  But first, a little note about the programming paradigm/style.

The course is taught using a [functional programming](https://en.wikipedia.org/wiki/Functional_programming) paradigm.  Now, you don’t need to know the specifics about the different paradigms of programming out there in order to do well in this course.   But I do think it’s a good thing to be aware of.  Check out [this](https://en.wikipedia.org/wiki/Programming_paradigm) page about programming paradigms to learn more.  I recommend doing some research about programming paradigms to get some exposure to the ideas at least.
...
For algorithms such as the problem set 1 part a from [Intro to CS using Python](https://github.com/ossu/computer-science#intro-cs) from this OSSU curriculum, I think supplementing step 4 with the [7 step problem solving technique](https://adhilton.pratt.duke.edu/sites/adhilton.pratt.duke.edu/files/u37/seven-steps-comped19.pdf) that I learned from the Coursera specialization mentioned above can help a little more to come up with a working algorithm, because its steps for coming up with an algorithm are more explicit.
...
Outside of this course, I haven’t had enough practice with SPD’s method to determine the true winner.  But we shouldn’t think of these as competing methods but rather tools that can both be handy whenever we need them.  For now, I’ll be looking to combine both.  The 7 Step Method doesn’t design functions, it’s specifically for writing out an algorithm (the code body).  I can use SPD’s method for the function specific details and the templating idea.  Both have a test and debug step.

SPD's method is powerful on its own though. This is a process that even experienced programmers might find to be new. The specific method was new to me, even though it had overlap with other ideas I've came across when it comes to writing/designing functions and solving problems. I am looking forward to taking the learnings from this course and applying it to future programs that I work with.
...
If you want a summary of key points for each module of SPD, along with a deeper discussion, I wrote a separate article for the first half of SPD [here](spd-first-half-modules.html), and the second half from the articles I wrote [here](category/systematic-program-design.html) (week 6b - week 11).  I wrote the key points of each module, along with my thoughts/analysis about them.  It can serve as a succinct summary of the course’s main ideas.  It might be useful to some people and I think it might be useful for myself to look back at.  I mostly have it as a journal for my learning experiences.
...
* [Developing Developers](https://felleisen.org/matthias/Thoughts/Developing_Developers.html) - author's perspective on developing developers
* [Thoughts](https://felleisen.org/matthias/Thoughts/py.html) - Q&A with one of the creators of the course