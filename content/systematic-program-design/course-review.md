...
Why this course?  Even though I’m not a beginner, I decided to humble myself and take the course anyway to see what I could learn from it, and share my learnings.  Also, this course is a part of the Open Source Society University’s Computer Science curriculum.  I am going through this curriculum to strengthen my fundamentals, as I discuss in my blog post [here](revisiting-software-fundamentals.html).
...
After doing some research and reading [this](https://cs.brown.edu/people/sk/Publications/Papers/Published/fffk-htdp-vs-sicp-journal/paper.pdf) paper comparing the two (though it’s written by the authors of How to Design Programs, so it may be biased), it seems to me that How to Design Programs might be better as an introductory course.  That’s not to say that SICP is useless.  In fact, I do plan on reading SICP sometime, maybe after completing the Core Programming section of OSSU.  It’s a part of the [teachyourselfcs](https://teachyourselfcs.com) curriculum.  But I digress.  Now, about the Systematic Program Design course structure.
